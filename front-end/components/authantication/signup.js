    ...
    >
      <div className="w-full max-w-lg bg-white backdrop-blur-md rounded-3xl shadow-2xl p-10" dir="rtl">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="اسم المستخدم" className="text-right border-[#e85d04] focus:ring-[#dc2f02]" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <p className="mt-6 text-xs text-[#6a040f] text-center leading-relaxed">
          ...
          <a href="#" className="text-[#d00000] hover:text-[#9d0208] hover:underline">شروط الاستخدام</a> و{" "}
          <a href="#" className="text-[#d00000] hover:text-[#9d02075b] hover:underline">سياسة الخصوصية</a>.
        </p>
