export const emailTempelateForgetPassword = (activeLink) => {
  const emailTemplate = `
    <html
    lang="en"
          ...
          <tr class="wp-block-editor-headingblock-v1">
            ...
            >
              <p
                ...
                class="heading1"
              >
                <span style="color: #ffffff">"استرجاع الحساب"<br /></span>
              </p>
            </td>
          </tr>
          <tr class="wp-block-editor-imageblock-v1">
                          ...
                          <tr class="wp-block-editor-headingblock-v1">
                            ...
                            >
                              <p
                                ...
                                class="heading2"
                              >
                                خطوة واحدة أخرى –  استرجاع الحساب
                              </p>
                            </td>
                          </tr>
                          <tr class="wp-block-editor-paragraphblock-v1">
                            ...
                            >
                              <p
                                ...
                                "
                              >
                                لقد تلقينا طلبًا لإعادة تعيين كلمة المرور الخاصة بحسابك على E-commerce.
                                لإتمام العملية، يرجى تأكيد هذا الطلب من خلال النقر على الرابط أدناه:
                              </p>
                            </td>
                          </tr>
